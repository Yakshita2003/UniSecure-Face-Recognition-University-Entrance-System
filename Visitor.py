...
def register():
    ...
    if submit:
        ...
        elif not Name or not Contact or not ID_type or not ID_no or not Purpose or not Image_file or not Gmail:
...
selected = option_menu(
    menu_title=None,
    options=["Home", "Register", "Recognize Face", "View Data"],
